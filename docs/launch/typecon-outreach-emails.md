...
MIT-licensed type editor with a 94-rule continuous audit module. Built
...
- patens.design/audit — the 94-code module
...
browser-native type editor with a 94-rule continuous audit that runs
...
94 codes against AI augmentation potential (75 algorithm-only, 11
...
Quick links:
- patens.design
- patens.design/audit (the 94 codes by family)
...
audit-as-pedagogy framing (94 rules with plain-English explanations,
...
browser-native type editor with a 94-rule audit module. I missed the
...
Patens is a browser-native MIT-licensed type editor with a 94-rule
