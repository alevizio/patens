...
The audit module — 97 codes covering contour geometry, vertical metrics, OpenType invariants, and multi-script coverage — is the editor's spine. WCAG 2.0 + 2.1 + 2.2 A/AA is enforced via axe-core in CI across 31 routes. The marketing surface ships in English and Rioplatense Spanish. MIT-licensed, solo-maintained, public CHANGELOG, transparent governance. Public launch at **TypeCon Portland, August 6–8, 2026**.
...
- **The Method (the 97 audit codes by family):** [patens.design/audit](https://patens.design/audit)
