...
+- [Patens](https://patens.design) - Open-source MIT, browser-native type design tool with a 101-rule audit module that explains every issue in plain English. Sketch glyphs, trace to Bézier, audit, kern, ship OpenType. [(Source)](https://github.com/alevizio/patens).
...
differentiator vs. the other entries in this subsection is its 101-rule
