...
| `research/ai-audit-mapping.md` | All 101 codes classified for AI augmentation | 415 |
...
- 93 of 101 `/audit/[code]` pages ship "Canonical references" section
...
- 101 prerendered audit pages (was 94); 89 ship canonical references
...
- [ ] **05:30 AM PT — submit Show HN** via `docs/launch/show-hn-draft.md`
  - Use Variant A title (recommended): "Show HN: Patens – a browser type editor with a 101-rule audit that teaches"
