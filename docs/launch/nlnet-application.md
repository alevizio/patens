...
> against a built-in 102-code rule set, and ship OpenType fonts —
> entirely in a browser tab, with no installs and no account.
>
> The differentiator is teaching: a 102-code audit module explains every
...
>
> Patens is teaching-first: the 102-code audit module is the spine.
