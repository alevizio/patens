...
> against a built-in 101-code rule set, and ship OpenType fonts —
> entirely in a browser tab, with no installs and no account.
>
> The differentiator is teaching: a 101-code audit module explains every
...
>
> Patens is teaching-first: the 101-code audit module is the spine.
...
> > is the leverage point. The audit module's 101 codes are 94
