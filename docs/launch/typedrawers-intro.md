...
```
Patens — a browser-based type editor with a 94-rule continuous audit (MIT, open source)
```
...
The marketing page is long-scroll editorial — annotated specimen of the demo font, an interface mock of the editing surface, the 94 codes by family, and a comparison vs every other tool in the field. The /audit page is the canonical reference for the codes.
