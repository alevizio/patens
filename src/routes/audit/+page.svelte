		...
		'@graph': [
			{
				...
				description:
					'An audit module that teaches as you draw. 97 codes covering contour shape, metrics, OpenType invariants, naming, coverage, anchors, variable fonts, color fonts, and brief completeness. Every code carries plain-English teaching prose; around 30 codes have a one-click fix.',
...
<svelte:head>
	...
	<meta
		name="description"
		content="Patens's audit module: 97 codes across contour shape, metrics, OpenType invariants, naming, coverage, anchors, variable fonts, color fonts, and brief completeness. Plain-English teaching prose on every code; around 30 codes have a one-click fix. Also runs as a CLI."
	/>
	...
	<meta
		...
		content="97 codes that teach as you draw. Every code carries plain-English prose, around 30 have one-click fixes. Also runs from the terminal."
	/>
	<meta property="og:image" content="https://patens.design/og/audit" />
	<meta property="og:image:alt" content="Patens — The audit module · 97 codes that teach as you draw · 30 one-click fixes · open source MIT" />
	<meta name="twitter:title" content="The audit module · Patens" />
	<meta
		name="twitter:description"
		content="97 codes that teach as you draw. Plain-English prose, ~30 one-click fixes, CLI integration."
	/>
	<meta name="twitter:image" content="https://patens.design/og/audit" />
	<meta name="twitter:image:alt" content="Patens — The audit module · 97 codes that teach as you draw · 30 one-click fixes · open source MIT" />
...
<div class="mx-auto max-w-5xl px-4 py-8 sm:px-6">
	...
	<p class="mt-3 text-[13px] text-fg-muted">
		...
		<a
			...
			class="font-medium text-accent-strong underline underline-offset-2 hover:text-accent"
		>glyph-name-not-canonical</a> to see them in context. 89 of 97 codes covered in the open MVP corpus; the remaining 8 require licensing the craft canon (Tracy, Smeijers, Noordzij, Cheng).
	</p>
	...
	<p class="mb-6 text-[14px] leading-relaxed text-fg-muted">
		The same 97-code engine ships as a CLI. Drop it into your CI as a font-design lint step, or batch-audit a directory of project files before a foundry release.
	</p>
