...
and the rest of the type-editor landscape is a built-in 97-code audit
...
designed as a teaching tool. The 97-code audit module + five teaching
...
- **97-code audit module**: contour shape, vertical metrics, OpenType
...
8. **Run the audit**. 97 codes across contour shape, vertical metrics,
...
const REFERENCE_AUDIT_CODES = `# Audit codes — 97 codes grouped by family
