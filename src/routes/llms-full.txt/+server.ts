...
designed as a teaching tool. The 94-code audit module + five teaching
...
- **94-code audit module**: contour shape, vertical metrics, OpenType
...
8. **Run the audit**. 94 codes across contour shape, vertical metrics,
...
const REFERENCE_AUDIT_CODES = `# Audit codes — 94 codes grouped by family
