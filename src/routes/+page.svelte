<script lang="ts">
	...
	// 9 audit families, 99 codes total. Examples + counts come from /audit
	...
	const compareRows: Array<{ label: string; values: Cell[] }> = [
		...
		{ label: '99-code teaching audit', values: [true, 'partial', 'partial', false, 'partial', false, false, false] },
...
<svelte:head>
	...
	<meta
		name="description"
		content="Patens is a type editor with 99 rules running underneath. Each rule explains itself in plain English, and ~30 of them fix the glyph for you. Open source, MIT, in the browser, no install. The Patens Method. Now in private alpha."
	/>
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Patens — a type editor with a method" />
	<meta
		property="og:description"
		content="99 rules for drawing a typeface, every one explained in plain English. Open source, MIT, in the browser. The Patens Method. Now in private alpha."
	/>
	...
	<meta
		...
		content="99 rules for drawing a typeface, every one explained in plain English. Open source, MIT, in the browser. The Patens Method."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		'@graph': [
			...
			},
			{
				...
				description:
					'Open-source browser-native type design tool with a 99-code teaching audit module.',
	...
	<main>
		...
		<section class="mb-32 border-t border-border/40 pt-16">
			<div class="mb-12 max-w-3xl">
				...
				<p class="mt-5 text-[15px] leading-relaxed text-fg-muted">
					Patens runs all 99 rules continuously. When a contour crosses itself, when an
			...
			<p class="mt-10 text-[13px] text-fg-muted">
				...
				<span class="ml-3 text-fg-subtle">
					· <a href="/learn/audit-codes" class="hover:text-fg">Full reference (99 codes)</a> · Also
					from the terminal:
		...
		<section class="mb-32 border-t border-border/40 pt-16">
			<div class="mb-10 max-w-3xl">
				<p class="font-mono text-[10px] tracking-[0.22em] text-fg-subtle uppercase">
					What the audit checks · 9 families, 99 rules
				</p>
				<h2
					class="mt-3 text-[28px] tracking-tight text-fg"
				...
				<p class="mt-5 text-[15px] leading-relaxed text-fg-muted">
					The 99 codes group into nine families. Each one runs continuously; each one has
