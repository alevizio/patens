...
<svelte:head>
	...
	<meta
		name="description"
		content="A type design tool that teaches as you draw. Sketch glyphs, trace to Bézier, ship OpenType — with a 99-code audit module that explains every finding. Open source, browser-native."
	/>
	...
	<meta
		...
		content="Browser-native type design tool with a 99-code audit module that teaches as you draw. Sketch, trace, ship OpenType. Open source MIT."
	/>
