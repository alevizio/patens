...
const buildPng = async (): Promise<Buffer> => {
	...
	const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
		...
		<!-- subtitle -->
		<text x="80" y="565" font-family="-apple-system,system-ui,Helvetica,Arial,sans-serif" font-size="22" fill="${MUTED}">SvelteKit · 97-code audit · variable fonts · open source · MIT</text>
	</svg>`;
