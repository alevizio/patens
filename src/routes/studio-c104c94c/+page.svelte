...
<svelte:head>
	<title>Your foundry — Patens</title>
	<!-- Gated alpha app surface: keep it out of the index. The public,
	     indexable marketing page lives at / (the teaser). -->
	<meta name="robots" content="noindex, nofollow" />
	<meta
		name="description"
		content="Patens is a type editor with 99 rules running underneath. Each rule explains itself in plain English, and ~30 of them fix the glyph for you. Open source, MIT, in the browser, no install. The Patens Method."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		'@graph': [
			...
			},
			{
				...
				featureList: [
					'99-code audit module with plain-English teaching prose on every code, one-click fixes on around 30 codes',
...
>
	...
	<!-- Trust band — Swiss-disciplined "by the numbers" row, sits between
	     ...
	     module (99 codes), the demo's scope (162 glyphs / 3 scripts),
	...
	>
		...
		<p class="mt-8 text-[13px] text-fg-muted">
			...
			<span class="ml-3 text-fg-subtle">
				· <a href="/learn/audit-codes" class="hover:text-fg">Full reference (99 codes)</a> · Also from the terminal: <code class="font-mono text-fg">npx patens audit</code>
			</span>
		</p>
	</section>
