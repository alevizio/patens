...
- **Citation engine MVP at `src/lib/citations/`** (5 files + 12 tests) — Feature 1 of `docs/research/ai-features-roadmap.md` going live. `CITATION_MAP` populated with anchor + gist data for 89 of 99 codes drawn from the 10-source open-licensed MVP corpus + variablefonts.io primer. 91 of 99 `/audit/[code]` prerendered pages ship a "Canonical references" section. Bibliographic citations only (no body-text ingest); craft-canon citations (Tracy/Smeijers/Noordzij/Cheng) flagged for license-required ingestion in Q3 2026.
...
- **3 new variable-font audit codes shipped (94 → 97)**:
  ...
  - Each with full describeAuditCode prose, citation mapping (OpenType STAT + variablefonts.io), check function in preflightProject(), and 11 new unit tests covering positive/negative/edge cases.
