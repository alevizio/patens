...
- **Citation engine MVP at `src/lib/citations/`** (5 files + 12 tests) — Feature 1 of `docs/research/ai-features-roadmap.md` going live. `CITATION_MAP` populated with anchor + gist data for 91 of 99 codes drawn from the 11-source open-licensed MVP corpus (OpenType spec, TrueType ref, AGL, FEA, UFO 3, Unicode 16, Sheep CC, OT Cookbook, Klim, Knuth 1979, variablefonts.io, Frere-Jones blog). 91 of 99 `/audit/[code]` prerendered pages ship a "Canonical references" section. Bibliographic citations only (no body-text ingest); craft-canon citations (Tracy/Smeijers/Noordzij/Cheng) flagged for license-required ingestion in Q3 2026.
